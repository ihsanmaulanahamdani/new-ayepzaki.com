  ...
  return (
    ...
    >
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">
          Terus ikuti pergerakan Saya dalam Menata Kebaikan
        </span>
      </h2>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Dapatkan notifikasi melalui email pada saat saya mem-posting blog, dan
...
function ProductList() {
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        <FolderOpenIcon className="h-6 w-6 flex-none" />
        <span className="ml-3">Product List</span>
      </h2>
      <ol className="mt-6 space-y-4">
        {products.map((product, productIndex) => (
          <li key={productIndex} className="flex gap-4">
        ...
        {contacts.map((contact, contactIndex) => (
          <li key={contactIndex} className="flex gap-4">
            ...
            <dl className="flex flex-auto flex-wrap gap-x-2">
              ...
              <dt className="sr-only">No Whatsapp</dt>
              <dd className="text-xs text-zinc-500 dark:text-zinc-400">
                {contact.description}
              </dd>
            </dl>
...
function Photos() {
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex flex-col items-center justify-center gap-5 overflow-hidden py-4 sm:gap-8 lg:flex-row">
        {[image1, image2, image3, image4].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
              'relative aspect-[9/10] w-5/6 flex-none overflow-hidden rounded-xl bg-zinc-100 px-10 dark:bg-zinc-800 lg:w-72 lg:rounded-2xl',
